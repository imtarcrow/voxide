...
[[nodiscard]] auto Window::get_handle() const noexcept -> SDL_Window * { return this->window; }

[[nodiscard]] auto Window::get_context() const noexcept -> SDL_GLContext { return this->context; }
