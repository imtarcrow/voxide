...
auto ShaderProgram::load_and_compile() -> bool {
    ...
    std::cout << "glCreateProgram ptr: " << (void *) glCreateProgram << '\n';
    std::cout << "glGetError before: " << glGetError() << '\n';
    GLuint shader_program = glCreateProgram();
    std::cout << "program handle: " << shader_program << '\n';
    std::cout << "glGetError after: " << glGetError() << '\n';
    ...
    std::optional<GLuint> fragment_shader =
        ShaderProgram::create_shader(this->fragment_shader_path, GL_FRAGMENT_SHADER);
